...
from ghostiss.core.quests.itf import QuestContext, QuestLib, Step, Quest
from ghostiss.core.quests.utils import get_quest_driver
from ghostiss.core.quests.steps import ObserveStep, FinishStep
...
class QuestContextImpl(QuestContext):
    ...
    def __init__(self, container: Container, parent: QuestLib, messenger: Messenger, max_step: int):
    ...
    def sub_context(self) -> "QuestContext":
        ctx = QuestContextImpl(container=self._container, parent=self, messenger=self._messenger.new())
