...
class RaisedNotice(GhostissError):
    """
...
class GhostContextError(GhostissError):
    """
    一次运行级别的 error, 让运行无效.
    """
    pass
...
class GhostissIOError(GhostissError):
    """
...
class GhostissRuntimeError(GhostissError):
    """
    让一个 runtime 进程失效退出.
    """
    pass
