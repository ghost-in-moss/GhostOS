...
class Task(BaseModel):
    ...
    # --- mind --- #
    idea: Normalized = Field(description="")

    # --- state --- #
    state: TaskState

    @classmethod
    def new(cls, process_id: str, thread_id: str, name: str, desc: str, mind_meta: Normalized, **kwargs) -> 'Task':
...
class Runtime(ABC):
    ...
    @abstractmethod
    def put_task_event(self, task_id: str, e: Normalized) -> None:
        pass
