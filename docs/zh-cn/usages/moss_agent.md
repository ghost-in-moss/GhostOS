...
`MossAgent` 是 `GhostOS` 项目最基本的 Agent 单元. 它使用 [MOSS Protocol](../concepts/moss_protocol.md) 提供代码交互界面,
...
生成 [MossAgent](https://github.com/ghost-in-moss/GhostOS/ghostos/ghosts/moss_agent/agent.py) 实例.
...
默认的反射原理, 请看 [MOSS Protocol](../concepts/moss_protocol.md). 简单来说:

1. 引用的函数会自动反射出函数名 + doc
2. 抽象类反射出源代码

大模型会根据 instruction, 调用名为 `moss` 的工具, 生成代码.
生成的代码会在 [Moss](https://github.com/ghost-in-moss/GhostOS/ghostos/core/moss/abcd.py) 编译的临时模块中执行.

源码请看 [MossAction](https://github.com/ghost-in-moss/GhostOS/ghostos/ghosts/moss_agent/agent.py#MossAction).
...
[MOSS Protocol](../concepts/moss_protocol.md) 系统默认的魔术方法在
[lifecycle](https://github.com/ghost-in-moss/GhostOS/ghostos/core/moss/lifecycle.py).
...
- [for developer](https://github.com/ghost-in-moss/GhostOS/ghostos/ghosts/moss_agent/for_developer.py): 面向开发者的生命周期管理
...
- [for meta ai](https://github.com/ghost-in-moss/GhostOS/ghostos/ghosts/moss_agent/for_meta_ai.py): 面向开发者和 AI
  的生命周期管理
...
- [moss lifecycle](https://github.com/ghost-in-moss/GhostOS/ghostos/core/moss/lifecycle.py): Moss 库的生命周期方法.

复制这些方法到当前文件, 既可以生效自定义魔术方法.
所有这些魔术方法都是 `可选的`. 如果能用来解决问题, 则可以使用它们.

如果一切魔术方法都不够用, 那么最好的办法是自己实现 `Ghost` 和 `GhostDriver` 类,
详见 [concepts.py](https://github.com/ghost-in-moss/GhostOS/ghostos/abcd/concepts.py)
...
2. `Runtime Injection`: 通过 [IoC Container](../concepts/ioc_container.md) 进行依赖注入.
...
详见 [instructions](https://github.com/ghost-in-moss/GhostOS/ghostos/ghosts/moss_agent/instructions.py)
...
进一步的,
如果挂载的数据对象实现了 [ghostos.prompter.Prompter](https://github.com/ghost-in-moss/GhostOS/ghostos/prompter.py),
...
Moss 类上挂载的 `abstract class` 会自动从 [IoC Container](../concepts/ioc_container.md) 进行依赖注入.
为这些抽象类提供实现有三种方法:
...
第三种方法是在 [IoC Container](../concepts/ioc_container.md) 中注册依赖实现.
...
- [App Root Container](https://github.com/ghost-in-moss/GhostOS/ghostos/bootstrap.py) : 进程唯一容器
...
- [LoggerItf](https://github.com/ghost-in-moss/GhostOS/ghostos/contracts/logger.py): 日志
- [Configs](https://github.com/ghost-in-moss/GhostOS/ghostos/contracts/configs.py): 配置文件
- [Workspace](https://github.com/ghost-in-moss/GhostOS/ghostos/contracts/workspace.py): 工作区
- [Variables](https://github.com/ghost-in-moss/GhostOS/ghostos/contracts/variables.py): 持久化变量存储
- [LLMs](https://github.com/ghost-in-moss/GhostOS/ghostos/core/llms/llms.py): 大模型
- [Assets](https://github.com/ghost-in-moss/GhostOS/ghostos/contracts/assets.py): 图片和音频
- [GhostOS](https://github.com/ghost-in-moss/GhostOS/ghostos/abcd/concepts.py): GhostOS 自身
- [Shell](https://github.com/ghost-in-moss/GhostOS/ghostos/abcd/concepts.py): 运行时生成的 Shell
- [Conversation](https://github.com/ghost-in-moss/GhostOS/ghostos/abcd/concepts.py): 运行时生成的 conversation
- [Session](https://github.com/ghost-in-moss/GhostOS/ghostos/abcd/concepts.py): 运行时生成的 Session, 管理主要的 API
- [Scope](https://github.com/ghost-in-moss/GhostOS/ghostos/abcd/concepts.py): 当前对话的座标.
- [Ghost](https://github.com/ghost-in-moss/GhostOS/ghostos/abcd/concepts.py): 当前 Agent 自身
- [MossCompiler](https://github.com/ghost-in-moss/GhostOS/ghostos/core/moss/abcd.py): moss 编译器
- [Tasks](https://github.com/ghost-in-moss/GhostOS/ghostos/core/runtime/tasks.py): 任务存储
- [Threads](https://github.com/ghost-in-moss/GhostOS/ghostos/core/runtime/threads.py): 历史消息存储
- [EventBus](https://github.com/ghost-in-moss/GhostOS/ghostos/core/runtime/events.py): 事件总线.
