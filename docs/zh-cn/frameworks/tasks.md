...
Agent 可以直接使用 [MOSS](../concepts/moss_protocol.md) 提供的类库来操作自身的状态: 
...
相关实现详见 [ghostos.core.runtime.tasks](https://github.com/ghost-in-moss/GhostOS/ghostos/core/runtime/tasks.py)