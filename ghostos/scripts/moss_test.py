import argparse
import sys
from ghostos.core.moss import test_container, MossTestSuite, MossResult
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="run ghostos moss test cases, show results from moss defined test cases",
    )
    parser.add_argument(
        "--modulename", '-m',
        ...
        default="ghostos.core.moss.examples.test_suite",
    )
    parser.add_argument(
        "--test_modulename", '-t',
