...
from ghostos.core.moss_p1 import MOSS, BasicPythonMOSSImpl, BasicModulesProvider
from ghostos.framework.messengers import TestMessengerProvider
from ghostos.framework.llms import ConfigBasedLLMsProvider
from ghostos.framework.moss.runner import MOSSRunnerTestSuite, MOSSRunnerTestResult
from ghostos.framework.llms.test_case import ChatCompletionTestCase, APIInfo
...
"""
    ...
    def factory(self, con: Container) -> Optional[ABSTRACT]:
        from ghostos.core.moss_p1 import Importing, Typing
        from abc import ABC, abstractmethod
        import typing
        from pydantic import BaseModel, Field
        from typing import TypedDict
        from ghostos.core.messages import Message, MessageKind, MessageClass
        args = []
        args.extend([
...
def _prepare_container() -> Container:
    ...
    # 注册 llms 配置.
    ghostos_dir = os.path.abspath(os.path.dirname(__file__) + "/../../demo/ghostos")
    container.register(FileStorageProvider(ghostos_dir))
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="run ghostos runner test cases which located at demo/ghostos/tests/moss_tests",
    )
