...
with a Turing-complete code interaction interface ([Moss Protocol](https://github.com/ghost-in-moss/GhostOS/tree/main/docs/zh-cn/concepts/moss_protocol.md)),
...
* [MossAgent](https://github.com/ghost-in-moss/GhostOS/tree/main/docs/zh-cn/usages/moss_agent.md): an agent that can interact with the python module
